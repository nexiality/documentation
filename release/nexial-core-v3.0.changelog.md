...
- Added new feature to check temp clean up during Nexial execution.
  
   
### [Batch Files](../userguide/BatchFiles)
- [bin/nexial-temp-clean](../userguide/BatchFiles#nexial-temp-clean): **NEW** batch file to clean up temp files
  generated by Nexial.
- [bin/nexial-custom-jar](../userguide/BatchFiles#nexial-custom-jar): **NEW** batch file to copy custom files/jars from
  source location to `${user.home}/.nexial/jar`.
